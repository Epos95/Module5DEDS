...
/**
 * <p>
 * A queue with all the events about to happen where the event that's next to
 * occur is in the beginning of the queue.
 * </p>
 * 
...
public class EventQueue {
	...
	/**
	 * Adds an event to the queue in the order in which it is to be exectued.
	 * 
