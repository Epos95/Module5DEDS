...
public class StoreState extends State {
	 ...
	 * Constructor
	 * 
	 * @param cashRegisters  Amount of cash registers in use during simulation.
	 ...
	 * @param pickingMin     Minimum time for picking.
	 ...
	 */
	public StoreState(int cashRegisters, int maxCustomers,
			double arriveInterval, double cashierMin, double cashierMax,
			double pickingMin, double pickingMax, double openingTime,
			int seed) {
		...
		cashierSpeed = new CashierSpeedCalculator(cashierMin, cashierMax, 
				RANDOMIZERSEED);
		pickingTime = new PickingTimeCalculator(pickingMin, pickingMax, 
				RANDOMIZERSEED);
